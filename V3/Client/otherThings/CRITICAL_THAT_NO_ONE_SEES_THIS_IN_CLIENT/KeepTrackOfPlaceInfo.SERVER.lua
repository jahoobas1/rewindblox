...
Keeps track of the game's player count and send's it back to lobby.

]]

--wait until we move into SSS (if this runs in SS)
repeat
	wait()
until script.Parent == game:GetService("ServerScriptService")
