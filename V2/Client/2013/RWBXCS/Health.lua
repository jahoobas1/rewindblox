--RWBXCS/Health.lua
--By ROBLOX in July 2011, modified by Jahoobas

--Do NOT edit

local HealthGUI_prototype = game.Players.LocalPlayer:WaitForChild("PlayerGui"):WaitForChild("RobloxGui"):WaitForChild("Health")
