...
--I already had this script lying around, and I didn't really want to redo the entire 2013 playerlist so I just copied and pasted.
--TODO rewrite this
...
local ADMINS = require(game.ReplicatedStorage.moderatorList)
...
function getMembershipTypeIcon(membershipType,playerName)
	...
	elseif membershipType == Enum.MembershipType.Premium or MPS:UserOwnsGamePassAsync(game.Players[playerName].UserId,827483825) then
		return "rbxassetid://17726326768"
...
local ScreenGui = Obj.Create"Frame"
{
	...
	Size = UDim2.new(1, 0, 1, 0),
	BackgroundTransparency = 1,
	Parent = game.Players.LocalPlayer.PlayerGui:WaitForChild("RobloxGui")
}
