...
function changeSurfaces()
	for i,e in pairs(game:GetDescendants()) do
		if e:IsA("BasePart") and not e.Parent:FindFirstChildOfClass("SpecialMesh") and not e.Parent:FindFirstChild("Humanoid") then
			...
			--e.Material = Enum.Material.SmoothPlastic -- THIS IS DONE BY THE MATERIAL SCRIPT NOW.
